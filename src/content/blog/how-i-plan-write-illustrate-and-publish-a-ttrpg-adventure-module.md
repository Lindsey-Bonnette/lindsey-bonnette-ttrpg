---
title: "How I Plan Write, Illustrate, and Publish a TTRPG Adventure Module"
description: "In this post I intend to go over my entire process for adventure writing."
pubDate: 2023-05-21
heroImage: "../../assets/blog/how-i-plan-write-illustrate-and-publish-a-ttrpg-adventure-module.png"
---
...
A good resource for encounter writing and adventure writing in general is [How to Write Adventure Modules That Don't Suck](https://www.drivethrurpg.com/product/182608/How-to-Write-Adventure-Modules-That-Dont-Suck)
...
The I take this new text and use [SlickWrite](https://www.slickwrite.com#!home) to check for grammar and other writing elements. In this phase I try to:
...
I use Affinity Publisher, but anything that can export a series of pdf pages will work. If you're doing POD, be sure to dig into what your printer requires, because they will likely have requirements. DriveThruRPG has some good documentation for [InDesign](https://help.onebookshelf.com/hc/en-us/articles/12780817467159-Preparing-Your-Book-for-Print-with-InDesign) or [Publisher](https://help.onebookshelf.com/hc/en-us/articles/12780801434647-Preparing-A-Book-For-Print-with-Affinity-Publisher#getting-to-know-your-workspace-0-4).

My go to articles for general design advice are by Explorers Design [\[1\]](https://www.explorersdesign.com/blogs/design-guide) [\[2\]](https://www.explorersdesign.com/blogs/design-guide/the-grid-system-how-to-layout-your-rpg).

You can use the [templates](https://www.drivethrurpg.com/pub_podbook_templates.php) (you have to be logged in) provided by DriveThruRPG for help with margins, bleeds, and such for each size paper. Their set up might be more forgiving to the printer on the margins than it needs to be for digital files, but they will get you started.
...
Photobashing takes photos and shoves them together to create something new. I have a [tutorial](https://www.lindseybonnetterpgpublishing.com/blog/photobashing-for-indie-ttrpg-art) on this on the blog already. For photobashing I use Affinity Photo (again the older version), but there is the free software GIMP that can do the same things. I use sites like [Pexels](https://www.pexels.com) to find free photos to use to create the art I need. Once I have created the piece, I usually apply [this](https://www.youtube.com/watch?v=XJeNT_4h2UM) "painting effect" in Affinity Photo. I just hides a lot of errors and helps make it look like you maybe hired an artist. There is also a free program called [FotoSketcher](https://fotosketcher.com) you can add on top for even more painterly feeling. You can also find other painting effects that might appeal more to you. Photo bashing is limited by the photos you can find and how well you can extract shapes and paint them together. It has limits.
...
The black and white pieces for interior art were rendered using Blender's Eevee renderer, which allows for a hand drawn look. The cover was a scene rendered with Blender's Cycles renderer. I used some materials from [PolyHaven](https://polyhaven.com).
...
DriveThruRPG has a good set of [documentation](https://help.onebookshelf.com/hc/en-us/articles/12780799278103-Set-Up-a-New-Title-or-Edit-an-Existing-Title-Listing) for their systems.

Itch.io has some good official [documentation](https://itch.io/docs/creators/faq), but alos this page with [image dimensions](https://starwest.itch.io/itch-page-image-templates) is super helpful.
